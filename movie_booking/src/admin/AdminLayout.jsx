...
import { FaChartPie, FaFilm, FaBuilding, FaChair, FaTicket, FaUsers, FaClapperboard, FaGlobe, FaRightFromBracket, FaBars } from "react-icons/fa6";
    ...
    <div className={`admin-shell ${collapsed ? "sidebar-collapsed" : ""}`}>
      ...
      <aside className="admin-sidebar">
        <div className="sidebar-logo">
          {collapsed ? (
            <span className="logo-icon" style={{ color: "var(--clr-accent)" }}><FaClapperboard /></span>
          ) : (
            <svg className="logo-text" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 88 26" style={{ height: "32px", width: "auto", color: "var(--clr-text)" }}>
               <g fill="none">
