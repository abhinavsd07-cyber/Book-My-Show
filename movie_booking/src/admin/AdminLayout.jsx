      ...
      >
        ...
        >
          {mini ? (
            ...
            <div className="flex flex-col leading-none overflow-hidden mt-1 select-none">
              <svg
                viewBox="0 0 250 80"
                className="h-7 w-auto text-white animate-fade-in"
                fill="none"
              ...
              <span className="text-[9px] text-slate-500 font-semibold uppercase tracking-[0.15em] ml-[3px] mt-1.5">
                Admin Console
              </span>
            </div>
          )}
