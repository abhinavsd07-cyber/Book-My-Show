      ...
      <div className="container">
        <div className="footer-brand-strip">
          ...
          <div className="footer-logo" style={{ display: "flex", justifyContent: "center" }}>
             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 88 26" style={{ height: "30px", filter: "grayscale(100%) brightness(200%)" }}>
                  <g fill="none">
        ...
        <div className="footer-links-grid">
          <div className="footer-column">
            ...
            <ul>
              ...
              <li><Link to="/explore">Coming Soon</Link></li>
              <li><Link to="/explore">Movie Reviews</Link></li>
              <li><Link to="/explore">Cinemas</Link></li>
            </ul>
          </div>
          <div className="footer-column">
            <h6>EVENTS</h6>
            <ul>
              <li><Link to="/">Comedy Shows</Link></li>
              <li><Link to="/">Music Concerts</Link></li>
          ...
          <div className="footer-column">
            ...
            <ul>
              ...
              <li><Link to="/">Current Openings</Link></li>
          ...
          <div className="footer-column">
            ...
            <ul>
              ...
              <li><Link to="/">Consumer Grievance</Link></li>
            </ul>
          </div>
        </div>
